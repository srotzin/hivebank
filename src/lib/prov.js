/**
 * smash.prov — Ed25519 signature middleware (CJS)
 * did:hive:hivebank
 *
...
const PROV_SERVICE_DID = 'did:hive:hivebank';
...
async function signResponse(method, path, bodyBytes, ts) {
...
async function verifyProvSig({ method, path, body_b64u = '', ts, sig_b64u }) {
...
module.exports = { PROV_SERVICE_DID, loadOrCreateKey, getPubkeyInfo, signResponse, shouldStamp, smashProvMiddleware, verifyProvSig };
